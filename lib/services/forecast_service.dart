...
class ForecastService {
  ...
  Future<Forecast> fetchForecast({
    required double lat,
    required double lon,
    required TemperatureUnitEnum temperatureUnit,
    required WindSpeedUnitEnum windSpeedUnit,
    required PrecipitationUnitEnum precipitationUnit,
  }) async {
    ...
    try {
      ...
      final uri = Uri.https('api.open-meteo.com', '/v1/forecast', {
        ...
        'wind_speed_unit': windSpeedUnit.value,
